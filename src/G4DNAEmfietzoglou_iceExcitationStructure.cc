...
G4DNAEmfietzoglou_iceExcitationStructure::G4DNAEmfietzoglou_iceExcitationStructure() 
{
...
G4double G4DNAEmfietzoglou_iceExcitationStructure::ExcitationEnergy(G4int level)
{
