...
G4DNAEmfietzoglou_iceIonisationStructure::G4DNAEmfietzoglou_iceIonisationStructure() 
{
...
G4double G4DNAEmfietzoglou_iceIonisationStructure::IonisationEnergy(G4int level)
{
