...
#ifndef G4DNAEmfietzoglou_iceIonisationStructure_h
#define G4DNAEmfietzoglou_iceIonisationStructure_h 1
 
#include "globals.hh"
#include <vector>

class G4DNAEmfietzoglou_iceIonisationStructure
{
public:
  
  G4DNAEmfietzoglou_iceIonisationStructure();
  
  virtual ~G4DNAEmfietzoglou_iceIonisationStructure();
