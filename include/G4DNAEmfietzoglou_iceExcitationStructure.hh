...
#ifndef G4DNAEmfietzoglou_iceExcitationStructure_h
#define G4DNAEmfietzoglou_iceExcitationStructure_h 1
 
#include "globals.hh"
#include <vector>

class G4DNAEmfietzoglou_iceExcitationStructure
{

public:
  
  G4DNAEmfietzoglou_iceExcitationStructure();
  
  virtual ~G4DNAEmfietzoglou_iceExcitationStructure();
